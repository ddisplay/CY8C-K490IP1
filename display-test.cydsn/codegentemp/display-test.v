// ======================================================================
// display-test.v generated from TopDesign.cysch
// 01/04/2018 at 10:54
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("90e09017-2a42-43d0-8b1c-ee91a0ec3667"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c33f13c8-e7be-424f-9abe-b8148b0f0354"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DOT_net;
	wire [0:0] tmpFB_0__DOT_net;
	wire [0:0] tmpIO_0__DOT_net;
	wire [0:0] tmpINTERRUPT_0__DOT_net;
	electrical [0:0] tmpSIOVREF__DOT_net;

	cy_psoc3_pins_v1_10
		#(.id("a46341fe-a176-46f3-91da-611d4b2cf1d7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DOT
		 (.oe(tmpOE__DOT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DOT_net[0:0]}),
		  .io({tmpIO_0__DOT_net[0:0]}),
		  .siovref(tmpSIOVREF__DOT_net),
		  .interrupt({tmpINTERRUPT_0__DOT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DOT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("e6389322-b557-4ea8-bc82-d661390a1995"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
